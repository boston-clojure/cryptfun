...
;; two time pad - homework assignment #1

;; decode the secret message
(def secret-message "32510ba98bb4abb8f71a1569a10cff655ccaee3fd8109858800802a5e109a86e0cc413fb6dd8eb2b7bf10c19afefae468a0287d02a4520")

;; give these messages encrypted with the same key
(def ctx [""
...
(defn likely-space?
  "xor nth element of vertical-slice with all the other elements and return the number
   of times that the xor yields a letter [A-Za-z]"
...
;;get all the keys by getting the likely keys for each slice. Some will be nil
(def ks (map #(likely-keys-per-slice (map hex->bytes ctx) %) (range 95)))

;;decrypt the target ciphertext by xor with our guessed keys.
;;If there's no guessed key (nil) then just return "_" char, 0x5F as a blank.
...
;; round tripping a message through various encodings
(ascii->hex "this is a secret")
(hex->bytes *1)
(map char *1)
(map int *1)
(bytes->hex *1)
...
;; Try out our new "real" key on on the encrypted message.
...
;; Try the new key on other messages encyrpted with that same key

(clojure.pprint/pprint (map #(decrypt real-key (nth ctx %)) (range 10)))
